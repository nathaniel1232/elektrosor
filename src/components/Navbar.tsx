    ...
    <header className="sticky top-0 z-50 shadow-md">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <Link href="/" className="flex items-center flex-shrink-0">
              <img src="/images/elektro_sor_logo.png" alt="Elektro Sør" className="h-9 sm:h-10 w-auto" />
            </Link>
      ...
      {mobileOpen && (
        <div className="md:hidden bg-white border-t border-gray-100 px-4 py-4 space-y-1 shadow-lg">
          <Link href="/tjenester/privat" className="block px-3 py-2 text-gray-700 hover:bg-blue-50 hover:text-blue-800 rounded" onClick={() => setMobileOpen(false)}>Privatmarkedet</Link>
          <Link href="/tjenester/naring" className="block px-3 py-2 text-gray-700 hover:bg-blue-50 hover:text-blue-800 rounded" onClick={() => setMobileOpen(false)}>Butikk / næring / industri</Link>
          <Link href="/referanser" className="block px-3 py-2 text-gray-700 hover:bg-blue-50 hover:text-blue-800 rounded" onClick={() => setMobileOpen(false)}>Referanser</Link>
          <Link href="/om-oss" className="block px-3 py-2 text-gray-700 hover:bg-blue-50 hover:text-blue-800 rounded" onClick={() => setMobileOpen(false)}>Om oss</Link>
          <Link href="/karriere" className="block px-3 py-2 text-gray-700 hover:bg-blue-50 hover:text-blue-800 rounded" onClick={() => setMobileOpen(false)}>Ledig stilling</Link>
          <Link href="/kontakt" className="block px-3 py-2 text-gray-700 hover:bg-blue-50 hover:text-blue-800 rounded" onClick={() => setMobileOpen(false)}>Kontakt oss</Link>
          <Link
            href="/bestilling"
            className="block mt-3 bg-red-600 text-white font-semibold px-4 py-2.5 rounded text-center"
